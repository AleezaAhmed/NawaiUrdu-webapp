                            ...
                            <div class="card" style="background-color: #ffffff5e;border: #ffffff5e;">
                                <div class="card-body p-0 auth-header-box" style="background-color: transparent;">
                                    <div class="text-center p-3">
                                        <a href="<?=base_url()?>User/login" class="logo logo-admin">
                                        ...
                                        <p class="text-muted text_color_black mb-0">Sign in to continue</p>  
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active p-3 pt-3" id="LogIn_Tab" role="tabpanel">                                        
                                            <form class="form-horizontal my-4" action="<?=base_url()?>User/loging_in" method="POST">
                                                ...
                                                <div class="form-group mb-0 row">
                                                    <div class="col-12 mt-2">
                                                        <button class="practice-button" type="submit">Log In <i class="fas fa-sign-in-alt ml-1"></i></button>
                                                        <button class="practice-button" onclick="location.href='<?=base_url()?>User/signup';" type="button">Sign Up <i class="fas fa-sign-in-alt ml-1"></i></button>
                                                    </div><!--end col--> 
                                                </div> <!--end form-group-->                           
                                            </form><!--end form-->
...
<script>
    $(document).ready(function() {
      ...
      Toast.fire({
        icon: 'success',
        title: 'Registration Complete, pleae login to continue'
      });
    });
</script>
<?
