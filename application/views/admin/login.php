...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="icon" type="image/png" href="<?=base_url()?>assets/images/kk.png" />
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active p-3 pt-3" id="LogIn_Tab" role="tabpanel">                                        
                                            <form class="form-horizontal my-4" action="<?=base_url()?>Admin/loging_in" method="POST">
                                                ...
                                                <div class="form-group mb-0 row">
                                                    ...
                                                    <button class="practice-button" type="submit">Sign In <i class="fas fa-sign-in-alt ml-1"></i></button>
                                                    </div><!--end col--> 
                                                </div> <!--end form-group-->                           
                                            </form><!--end form-->
